...
int test_mitra_star_correctness()
{
    ...
    MitraStarClient mitra_clnt;
    MitraStarServer mitra_srv;
    ...
    mitra_clnt.search_stage2("abc", Fw, ret,labels,ciphers);
    mitra_srv.save(labels, ciphers);
